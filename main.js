...
const NPCS_FULL = [  
  ...
  {  
    ...
    dialog1:"Александр Кир: Вот в семьдесят восьмом мы резали пленку ножницами, монтаж делали на воске, фотонабор на «Линотроне», краски вручную мешали, а контрольный оттиск проверял Иван Петрович лично.", prob1:60,  
  ...
  {  
    ...
    type:'chill',home:[4],  
    dialog1:"Палина: Позовите Антона, у меня новые стрелки на лице!.", prob1:60,  
