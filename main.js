...
const NPCS_FULL = [
  {
    ...
    type:'kvest',
    // home - в какие комнаты NPC может ходить (индексы из ROOMS)
    home:[0,1],
    follow:false,             // Если true - будет "ходить" за игроком
    // Вероятности (проценты, сумма не обязательно 100)
    prob1:60, prob2:30, prob3:10,
    // Три фразы с разным шансом появления
  ...
  },
  {
    ...
    type:'barrier',
    home:[0,1],
    said:false, // Для сюжетного поведения
    prob1:60, prob2:30, prob3:10,
  ...
  },
  {
    ...
    type:'slow',
    home:[4,5,8],
    prob1:40, prob2:30, prob3:30,
    dialog1:"Александр Кир: Вот в 1978 мы резали пленку ножницами, монтаж делали на воске, фотонабор на «Линотроне», краски вручную мешали, а контрольный оттиск проверял Иван Петрович лично.",
